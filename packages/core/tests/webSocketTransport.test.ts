...
class CapturingLogger implements Logger {
  ...
  debug(message: string, context?: LogContext): void {
    this.entries.push(context === undefined ? { level: 'debug', message } : { level: 'debug', message, context });
  }

  info(message: string, context?: LogContext): void {
    this.entries.push(context === undefined ? { level: 'info', message } : { level: 'info', message, context });
  }

  warn(message: string, context?: LogContext): void {
    this.entries.push(context === undefined ? { level: 'warn', message } : { level: 'warn', message, context });
  }

  error(message: string, context?: LogContext): void {
    this.entries.push(context === undefined ? { level: 'error', message } : { level: 'error', message, context });
  }
